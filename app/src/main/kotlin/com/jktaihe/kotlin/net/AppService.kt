...
import com.jktaihe.kotlin.net.ConfigService.pageSize
...
interface TestService{
    @GET("joke/content/list.from?key=c8c21b0f0f42b2e30d5e25f6701b9cee&pagesize=$pageSize&pagesize=10&sort=asc")
    fun getTestList(@Query("time") time:String): Observable<ApiResponse<ResultBean>>
}
